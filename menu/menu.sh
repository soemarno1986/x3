...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Nanausam-x3/PERMISSION/ULIN/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/Nanausam-x3/PERMISSION/ULIN/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Nanausam-x3/PERMISSION/ULIN/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/Nanausam-x3/PERMISSION/ULIN/ip | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/Nanausam-x3/x3/ULIN/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "${BIPurple} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BIPurple} │                  ${BIWhite}${UWhite}NanausamVpnStore${NC}"
echo -e "${BIPurple} │"
...
echo -e "${BIPurple} │  ${BICyan}NS        :  ${BIYellow}$(cat /root/nsdomain)${NC}"
echo -e "${BIPurple} │  ${BICyan}DOMAIN    :  ${BIYellow}$(cat /etc/xray/domain)${NC}"
echo -e "${BIPurple} │  ${BICyan}RAM       :  ${BIYellow}$totalram MB${NC}"
...
echo -e "${BIPurple} │  ${BICyan}WHATSAP   :  ${BIYellow}+62 858-8135-85109${NC}"
echo -e "${BIPurple} │  ${BICyan}DEVELOVER :  ${BIYellow}Nanausam-x3${NC}"
echo -e "${BIPurple} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BIPurple} ┌─────────────────────────────────────────────────────┐${NC}" 
